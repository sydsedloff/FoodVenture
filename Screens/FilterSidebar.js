...
export default function FilterSidebar({ navigation }) {
  ...
  return (
    <View style={[styles.container]}>
      <HeaderComponent />
      <Text style={[styles.pageHeaders]}>Filters</Text>
      ...
      <View style={[styles.filterContainer, styles.flexColumn, styles.width80]}>
        <Pressable
          style={[styles.horizontalAlign, styles.bottomMargins, styles.width50]}
        ...
        >
          ...
          />
          <Text style={[styles.checkBoxText, styles.bold]}>Gluten Free</Text>
        </Pressable>
        <Pressable
          style={[styles.horizontalAlign, styles.bottomMargins, styles.width50]}
        ...
        >
          ...
          />
          <Text style={[styles.checkBoxText, styles.bold]}>Pescatarian</Text>
        </Pressable>
      ...
      <View style={[styles.filterContainer, styles.flexColumn, styles.width80]}>
        ...
        >
          ...
          />
          <Text style={[styles.checkBoxText, styles.bold]}>0-10 mi</Text>
        </Pressable>
        <Pressable
          style={[styles.horizontalAlign, styles.bottomMargins, styles.width50]}
      ...
      <Pressable
        ...
        style={[styles.buttonLarge.r, styles.width50]}
      >
